...
export default function Login() {
  ...
  const handleGoogleCredential = useCallback(async (credential) => {
    ...
    setError(null);
    try {
      const selectedRole = tab === 'register'
      ...
      const detail = err.response?.data?.detail;
      const errorMsg = typeof detail === 'string' ? detail : detail?.message || err.message || 'Google login failed';
      setError(errorMsg);
    } finally {
      setLoading(false);
    }
  }, [loginRole, persistSession, role, tab]);
        ...
        <div className="auth-form-wrap">
          ...
          {tab === 'login' ? (
            <div className="form-panel active">
              <p className="subtitle">Don't have an account? <button type="button" className="auth-text-link" onClick={() => setTab('register')}>Create one -></button></p>
              <form onSubmit={handleLogin}>
                ...
                <div className="form-group">
                  <label className="form-label" style={{ display: 'flex', justifyContent: 'space-between' }}>
                    Password
                    <button type="button" className="auth-text-link" style={{ fontWeight: 500, fontSize: 12 }}>Forgot?</button>
                  </label>
              ...
              <p className="form-footer-note">By signing in you agree to our <a href="/terms">Terms</a> and <a href="/privacy">Privacy Policy</a>.</p>
            </div>
          ) : (
            <div className="form-panel active">
              <p className="subtitle">Already have an account? <button type="button" className="auth-text-link" onClick={() => setTab('login')}>Sign in -></button></p>
              ...
              <p className="form-footer-note">By creating an account you agree to our <a href="/terms">Terms</a> and <a href="/privacy">Privacy Policy</a>.</p>
            </div>
          )}
