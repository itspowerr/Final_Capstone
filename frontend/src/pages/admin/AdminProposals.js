...
export default function AdminProposals() {
  ...
  useEffect(() => { fetchProposals(page, search, filterStatus); }, [page, search, filterStatus, fetchProposals]);
  ...
  return (
    <div style={{ padding: '28px 32px' }}>
      <div className="admin-section-header">
        <h2 style={{ fontSize: 20, fontWeight: 800 }}>Proposals <span style={{ fontSize: 14, color: 'var(--text-3)', fontWeight: 400 }}>({data.total})</span></h2>
